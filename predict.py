...
from main_test_x2sr import define_model, test
...
class Predictor(BasePredictor):
    def setup(self):
        ...
        paths = [
            "weights/X2SR_ClassicalSR_X4_64.pth",
            "weights/X2SR_CompressedSR_X4_48.pth",
            "weights/X2SR_RealworldSR_X4_64_BSRGAN_PSNR.pth",
        ]
        sizes = [64, 48, 128]
